    ...
    <div className='p-4'>
      <form className='m-auto w-full max-w-md shadow flex flex-col p-3 bg-white' onSubmit={handleSubmit}>
        ...
        <select className='bg-slate-200 p-1 my-1' name='category' id='category' onChange={handleOnChange} value={data.category}>
          <option value={"other"}>Select Cateogry</option>
        ...
        <textarea rows={2} name='description' className='bg-slate-200 p-1 my-1 resize-none' id='description' onChange={handleOnChange} value={data.description}></textarea>
